...
-- Aplica força ao objeto. Parâmetros (forçaX, forçaY, aplicação da forçaX, aplicação da forçaY)
retangulo:applyForce (20, 10, retangulo.x, retangulo.y )
-- Aplica força rotacional ao corpo.
--retangulo:applyTorque (100)
-- aplica impulso angular ao corpo.
retangulo:applyAngularImpulse (10)
