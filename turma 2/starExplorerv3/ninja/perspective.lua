...
Uma biblioteca para integrar facilmente e sem problemas uma câmera virtual em seu jogo.

Baseado na versão modificada do sistema de câmeras Dusk.

v2.1.0 permite que você anexe camadas na frente, começando com o índice 0, e corrija
comportamento de compensação.

A Perspective está licenciada sob a licença do MIT. Aproveitar.
--]]
